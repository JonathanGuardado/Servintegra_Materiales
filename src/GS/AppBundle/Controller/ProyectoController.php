...
class ProyectoController extends Controller {
    ...
    public function indexAction() {
        ...
        return $this->render('AppBundle:Proyecto:index.html.twig', array('proyectos' => $proyectos)
        );
    }
    ...
    public function showAction($id) {
        ...
        return $this->render('AppBundle:Proyecto:show.html.twig', array('proyecto' => $proyecto)
        );
    }
    ...
    public function newAction(Request $request) {
        ...
        if ($formulario->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add('info', 'Se ha creado el proyecto.'
            );
    ...
    public function editAction(Request $request, $id) {
        ...
        if ($formulario->isValid()) {
            ...
            $em->persist($proyecto);
            $em->flush();
            $this->get('session')->getFlashBag()->add('info', 'Los datos del proyecto se han actualizado.'
            );
    ...
    public function deleteAction($id) {
        ...
        $this->get('session')->getFlashBag()->add('info', 'Se ha eliminado el proyecto.'
        );
