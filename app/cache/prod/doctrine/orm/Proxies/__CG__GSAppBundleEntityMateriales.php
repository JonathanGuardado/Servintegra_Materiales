 ...
 */
class Materiales extends \GS\AppBundle\Entity\Materiales implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'id', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'categoria', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'codigo', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'nombre', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'descripcion', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'precioVenta', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'costo', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'stock', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'ubicacion', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'estado', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'usuario', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'createdAt', '' . "\0" . 'GS\\AppBundle\\Entity\\Materiales' . "\0" . 'updateAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Materiales $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCategoria(\GS\AppBundle\Entity\Categorias $categoria)
    {
