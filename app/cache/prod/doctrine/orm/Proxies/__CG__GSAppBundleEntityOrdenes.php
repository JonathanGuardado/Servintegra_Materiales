 ...
 */
class Ordenes extends \GS\AppBundle\Entity\Ordenes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'id', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'detalle', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'material', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'cantidad', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'valor', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'usuario', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'createdAt', '' . "\0" . 'GS\\AppBundle\\Entity\\Ordenes' . "\0" . 'updateAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ordenes $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDetalle(\GS\AppBundle\Entity\Detalles $detalle)
    {
     ...
     * {@inheritDoc}
     */
    public function setMaterial(\GS\AppBundle\Entity\Materiales $material)
    {
     ...
     * {@inheritDoc}
     */
    public function addDetalle(\GS\AppBundle\Entity\Detalles $detalle)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addDetalle', array($detalle));
