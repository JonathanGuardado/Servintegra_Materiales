 ...
 */
class Envios extends \GS\AppBundle\Entity\Envios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'id', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'proyecto', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'material', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'cantidad', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'envio', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'estado', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'usuario', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'createdAt', '' . "\0" . 'GS\\AppBundle\\Entity\\Envios' . "\0" . 'updateAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Envios $proxy) {
    ...
    public function setEnvio($envio)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEnvio', array($envio));

        return parent::setEnvio($envio);
    }
