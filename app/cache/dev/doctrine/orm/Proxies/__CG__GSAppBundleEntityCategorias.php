 ...
 */
class Categorias extends \GS\AppBundle\Entity\Categorias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GS\\AppBundle\\Entity\\Categorias' . "\0" . 'id', '' . "\0" . 'GS\\AppBundle\\Entity\\Categorias' . "\0" . 'nombre', '' . "\0" . 'GS\\AppBundle\\Entity\\Categorias' . "\0" . 'descripcion', '' . "\0" . 'GS\\AppBundle\\Entity\\Categorias' . "\0" . 'usuario', '' . "\0" . 'GS\\AppBundle\\Entity\\Categorias' . "\0" . 'createdAt', '' . "\0" . 'GS\\AppBundle\\Entity\\Categorias' . "\0" . 'updateAt');
        }
